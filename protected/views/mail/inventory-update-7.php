...
<p class=MsoNormal style='line-height:115%'>Hi <?php echo $quote3Banner->quote3->member->namaDepan; ?>,</p>

<p class=MsoNormal style='line-height:115%'>&nbsp;</p>

<p class=MsoNormal style='line-height:115%'>Dibawah ini adalah foto pemasangan
dari <?php echo $quote3Banner->banner->sku; ?> untuk campaign #<?php echo $quote3Banner->quote3->id ?> <?php echo $quote3Banner->quote3->name; ?> Anda:</p>
