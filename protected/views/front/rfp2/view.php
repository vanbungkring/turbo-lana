				...
				<section id="banner-detail-info-list" class="banner-info-body">
					...
					<div class="table-responsive">
						<table class="table table-bordered ">
							<tbody>
								<tr>
									<td class="front">Start Date</td>
									<td> <?php echo CHtml::encode($model->tanggalAwal); ?>  </td>
								</tr>
								<tr>
									<td class="front">End until</td>
									<td> <?php echo CHtml::encode($model->tanggalAkhir); ?>  </td>
								</tr>
							</table>
						</div>
					</section>
								...
								<div class="table-responsive">
									<table class="table table-bordered ">
										...
										<tbody id="bodySelectedBanner">
											<tr id="rowbanner-<?php echo $model->banner->id; ?>">
												<td><a href="#banner-map" class="gotomap" data-lat="<?php echo $model->banner->lat; ?>" data-long="<?php echo $model->banner->long; ?>" data-zoom="<?php echo $model->banner->zoom; ?>">Go to Map</a></td>
												<td class="front"><?php echo $model->banner->nama; ?><input type="hidden" value="<?php echo $model->banner->id; ?>" name="bannerIds[]" /></td>
												<td><?php echo $model->banner->lokasi; ?></td>
											</tr>
									</tbody>
								</table>
							</div>
...
$js = '
var mapOptions = {
	zoom: '.((int)$model->banner->zoom ? $model->banner->zoom : 20).',
	center: new google.maps.LatLng('.$model->banner->lat.', '.$model->banner->long.'),
};
...
var markers = '.CJSON::encode(array($model->banner)).';
