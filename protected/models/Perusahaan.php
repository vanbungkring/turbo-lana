...
class Perusahaan extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, nama, alamat, noTelpon, fax, kontakPerson, website, email', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('noTelpon',$this->noTelpon,true);
		$criteria->compare('fax',$this->fax,true);
		$criteria->compare('kontakPerson',$this->kontakPerson,true);
