...
/**
 * This is the model class for table "quote_banner".
 *
 * The followings are the available columns in table 'quote_banner':
 * @property integer $id
 * @property integer $idQuote
 * @property integer $idBanner
 */
class QuoteBanner extends CActiveRecord
{
	/**
	 ...
	 * @return QuoteBanner the static model class
	 */
